...
public class PersistenceApp {
	...
	public static void main (String []args) {
		...
		Factura factura1 = Factura.builder().numero(15).fecha("15/05/21").build();
		Factura factura2 = Factura.builder().total(200).fecha("15/05/21").build();
		
		
		System.out.println(factura1.toString());
		System.out.println(factura2.toString());
		
		Articulo articulo = Articulo.builder().cantidad(22).denominacion("Shampoo").build();
